            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="loginUser.php" onsubmit="return valid_login()" method="post">
                            <fieldset>
								...
								<div class="form-group">
                                    <input class="form-control" placeholder="Phone" name="phone" id="phone" type="phone"  autofocus>
                                    <small id="err_email" class="form-text err_msg">Email is required</small>
                                </div>
                                <div class="form-group">
